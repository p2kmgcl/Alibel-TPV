alibel.templates.ItemEdit = '\n\
    ...
    <fieldset>\n\
        ...
        <label for="maxStock">Stock máximo</label><input type="number" name="maxStock" value="<%= maxStock %>" />\n\
    </fieldset>\n\
    \n\
    ...
    <input type="button" class="deleteButton ui-state-error" name="delete" value="Eliminar ítem" />\n\
';
